...
class JointSineActionCfg(JointActionCfg):
    ...
    *((-np.pi, np.pi) for _ in range(16)),  # amplitude 


    (-np.pi, np.pi),  # frequency_vertical
    (-np.pi, np.pi),  # phase_vertical (0.78~1.57)
    (-np.pi, np.pi),  # frequency_horizontal
    (-np.pi, np.pi),  # phase_horizontal (0.78~1.57)
