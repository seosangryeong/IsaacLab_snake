...
class JointSineAmpAction(ActionTerm):
    ...
    """
    cfg: actions_cfg.JointSineAmpActionCfg
    _asset: Articulation
    _current_time: float

    def __init__(self, cfg: actions_cfg.JointSineAmpActionCfg, env: ManagerBasedEnv) -> None:
