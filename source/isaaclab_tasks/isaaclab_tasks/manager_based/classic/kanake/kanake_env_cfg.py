...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        params={
            ...
            "pose_range": {"x": (0.0, 0.0), "y": (0.0, 0.0), "x": (0.05, 0.05), "yaw": (0.0, 0.0)},
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
    ...
    reset_base = EventTerm(
        ...
        params={
            # "pose_range": {"x": (0.0, 0.0), "y": (0.0, 0.0), "yaw": (-1.57,1.57)},
            "pose_range": {"x": (0.0, 0.0), "y": (0.0, 0.0), "x": (0.05, 0.05), "yaw": (-1.57, 1.57)},
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
...
class RewardsCfg:
    ...
    progress = RewTerm(func=mdp.progress_reward, weight=5.0, params={"target_pos": (10.0, 0.0, 0.0)})
    ...
    upright = RewTerm(func=mdp.upright_posture_bonus, weight=1.0, params={"threshold": 1.0})
...
class TerminationsCfg:
    ...
    # max = DoneTerm(func=mdp.body_height_over_maximum, params={"maximum_height": 0.2})
