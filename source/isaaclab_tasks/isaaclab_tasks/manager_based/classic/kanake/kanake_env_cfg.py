...
class ActionsCfg:
    ...
    # joint_effort = mdp.JointEffortActionCfg(asset_name="robot", joint_names=[".*"], scale=0.1)
    ...
    #     # joint_names=["j6",  "j8",  "j10", "j12", "j14", "j16"], 
    #     scale=0.5)
    
    # joint_pos = mdp.JointPositionActionCfg(
    #     asset_name="robot", 
    #     joint_names=["j1","j2", "j3", "j4", "j5", "j7", "j9", "j11", "j13", "j15"], 
    #     scale=0.5, 
...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        params={
            ...
            "pose_range": {"x": (0.0, 0.0), "y": (0.0, 0.0), "z": (0.1, 0.1), "yaw": (-1.57,1.57)},
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
...
class RewardsCfg:
    ...
    # progress = RewTerm(func=mdp.progress_reward, weight=15.0, params={"target_pos": (10.0, 0.0, 0.0)})
    progress_cumulative_reward = RewTerm(func=mdp.progress_x_reward, weight=10.0)
    progress_y_penalty = RewTerm(func=mdp.progress_y_penalty, weight=-1.0)
    # alive = RewTerm(func=mdp.is_alive, weight=0.5)
    # move_to_target = RewTerm(func=mdp.move_to_target_bonus, weight=1.0, params={"threshold": 0.95, "target_pos": (10.0, 0.0, 0.0)})
    upright_posture_shaped = RewTerm(func=mdp.upright_posture_shaped, weight=1.0, params={"threshold": 0.8})
    # progress_x_distance_reward = RewTerm(
    #     func=mdp.progress_x_distance_reward,
    #     weight=5.0,
    # )
    # heading = RewTerm(func=mdp.heading, weight=1.5, params={"target_pos": (10.0, 0.0, 0.0)})
    # JointSmoothnessReward = RewTerm(
    #     func=mdp.JointSmoothnessReward,
    #     weight=-1.0,
